...
\gls{ai} programs and their underlying concepts are also often considered intelligent. This is mainly due to the fact that they work in ways that do not come to you straight away. Because of that it is often perceived that \gls{ai} programs and the concepts used within them to solve cognitive functions are really complicated and therefore intelligent.
But in programming it and actually coming up with the idea of a program (and its concepts) that is considered to be an \gls{ai}, the myth of this intelligence is already debunked and does not pose any intelligence anymore. This illustrates the possible paradox in \gls{ai}.
...
Learning itself plays a huge part in cognitive functions. Learning essentially means using a set knowledge base and progressively improve performance on a given task by adding new data to that knowledge base or by 
